...
All visualizations formats files can be downloaded from [here](/IllustryDocs/src/assets/illustry_file_formats.zip)

- **Example 1**: JSON format with all the details

![Visualizations JSON full details](/IllustryDocs/src/assets/visualizations_json_full.gif)

- **Example 2**: JSON format with partial details, complete the form with the missing details

![Visualizations JSON partial details](/IllustryDocs/src/assets/visualizations_json_partial.gif)

- **Example 3**: Excel format with all the details, complete the mapping of fields

![Visualizations Excel full details](/IllustryDocs/src/assets/visualizations_excel_full.gif)

- **Example 4**: Excel format with partial details, complete the form with the missing details

![Visualizations Excel partial details](/IllustryDocs/src/assets/visualizations_excel_partial.gif)

- **Example 5**: CSV format with all the details, complete the mapping of fields

![Visualizations CSV full details](/IllustryDocs/src/assets/visualizations_csv_full.gif)

- **Example 6**: CSV format with partial details, complete the form with the missing details

![Visualizations CSV partial details](/IllustryDocs/src/assets/visualizations_csv_partial.gif)

- **Example 7**: XML format with all the details

![Visualizations XML full details](/IllustryDocs/src/assets/visualizations_xml_full.gif)

- **Example 8**: XML format with partial details, complete the form with the missing details

![Visualizations XML partial details](/IllustryDocs/src/assets/visualizations_xml_partial.gif)