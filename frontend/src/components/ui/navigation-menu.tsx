...
const navigationMenuBase = 'group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2'
...
const navigationMenuTriggerStyle = cva(navigationMenuBase);
